...
Parameterwertbereich_Test = {
        ...
        ## Parameter Bauteil - Deckenplatten/-balken
        'slab_thickness': [0.25], # --> Dicke der Geschossdecke
        ## Parameter Bauteil - Balken
...
Parameterwertbereich_Mix = {
        ## Parameter Gitterstruktur
        'grid_x_n': [4, 6],
        'grid_y_n': [3, 8],
        'grid_x_size': [5.0, 6.0], # in [m]
        'grid_y_size': [2.5, 8.0], # in [m]
        'grid_rotation': [0, 45], # in [degree]
        'grid_x_offset': [0.0], # in [m]
        'grid_y_offset': [0.0], # in [m]
        ## Parameter Geschoss
        'floors': [4, 6],
        ...
        'slab_thickness': [0.25], # --> Dicke der Geschossdecke
        ## Parameter Bauteil - Balken
        'beam_profile': [ProfileFactory('i-profile', 'IPE300').profile, ProfileFactory('rectangle', 0.3, 0.3).profile], # --> QS-Profil der Balken
        ## Parameter Bauteil - Wände
        'wall_prob': [0.6], # --> Wand-Wahrscheinlichkeit
        'wall_thickness': [0.24], # --> Wanddicke        
        ## Parameter Bauteil - Stützen
        'column_prob': [0.8], # --> Stützen-Wahrscheinlichkeit
        'column_profile': [ProfileFactory('circle', 0.2).profile, ProfileFactory('i-profile', 'IPE300').profile], # --> Stützenprofil mit entsprechenden Parametern
}