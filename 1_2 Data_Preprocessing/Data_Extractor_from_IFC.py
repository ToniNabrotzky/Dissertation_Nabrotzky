...
def main():
    ...
    for ifc_folder_path in ifc_folder_paths:
        # print(f"IFC-Folder-Path - {ifc_folder_path.exists()}:  {ifc_folder_path}") #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
def extract_ifc_data(ifc_folder_path):
    ...
    if not ifc_folder_path.exists():
        print(f"__Ordner nicht gefunden. Fehlender Pfad: {ifc_folder_path}")
    else:
...
def export_data_to_json(extracted_data, ifc_folder_path, ifc_file):
    ...
    export_folder_name = os.path.basename(os.path.normpath(ifc_folder_path)) # Name des letzten Ordners aus Pfad
    export_folder_path = script_dir / export_folder_name / 'IFC_Extract'
    # print(f"script_dir: {script_dir}") #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    # print(f"json_folder_name: {json_folder_name}") #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    # print(f"json_folder_path: {json_folder_path}") #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    os.makedirs(export_folder_path, exist_ok=True) # Ordner erstellen, falls noch nicht vorhanden    
    ...
    json_file_path = export_folder_path / json_file_name
